...
Hooks.on("init", () => {
    ...
    // things to run on creat
    Hooks.on('createJournalEntryPage', game.JournalLink.initNewPage.bind(jl));
    //Hooks.on('preCreateJournalEntryPage', game.JournalLink.initNewPage.bind(jl));
    //Hooks.on('preUpdateJournalEntryPage', game.JournalLink.initNewPage.bind(jl));
